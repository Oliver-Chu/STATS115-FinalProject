...
**Q1.** Given `r round(xDay)` days since the last M8+ earthquake, the conditional expected remaining wait is **~`r round(mean(remainDays))` days** (95% CI: `r round(quantile(remainDays, 0.025))` - `r round(quantile(remainDays, 0.975))` days).
...
- Make prediction of actual wait time conditional
